...
def source_state():
    ...
    return {'layer_versions': layer_versions, 'parser_enabled': False, 'parser_version': None,
            ...
            'git_commit': commit, 'git_tree': tree, 'working_tree_dirty': dirty,
