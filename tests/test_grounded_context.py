...
@pytest.mark.parametrize('text,status',[
 ...
 ('오늘 할 일 브리핑해 줘.','pending'),('오늘 할 일 간단히 요약해 줘','pending'),
 ('오늘 일정 브리핑해 줘','all'),('오늘 할 일 목록 정리해 줘','pending'),
 ...
 ('2026-09-21 남은 할 일 알려줘','pending'),('2026년 9월 21일 할 일 보여줘','pending'),
 ('다음 주 남은 할 일 알려줘','pending'),('다음 달 일정 보여줘','all'),
 ('전체 날짜 할 일 보여줘','pending'),('오늘， 남은， 할 일 알려줘','pending'),
])
