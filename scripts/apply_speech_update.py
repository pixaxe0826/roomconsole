...
PATCH_ID='room-hub-0.1.3-speech1'
...
def plan_update(package:Path,target:Path)->tuple[dict,list]:
 ...
 if version not in {'0.1.2','0.1.3'}:raise ValueError('This patch requires an existing 0.1.2 installation. No files changed.')
