...
Room Hub는 방에 남는 iPad를 시계·날씨·할 일·달력 허브로 사용하고, 같은 LAN의 로컬 서버가 데이터 저장·실시간 동기화·음성 전사를 담당하도록 만든 개인용 프로젝트입니다. 현재 소스는 **0.1.6**이며, 이전 버전의 패치를 순서대로 적용할 필요가 없는 통합본입니다.
